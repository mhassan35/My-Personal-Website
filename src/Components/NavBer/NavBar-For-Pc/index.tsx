...
const NavBarPage = () => {
  ...
  return (
    <div className={`w-full h-[50px] md:h-[80px] backdrop-filter backdrop-blur-lg bg-slate-200/[0.25] flex items-center justify-between z-20 sticky top-0 transition-transform duration-300 ${show} `}>
